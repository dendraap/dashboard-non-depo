            ...
            <div class="row p-2 sub-menu h-100">
                            ...
                            <div class="card-body ps-2 pe-0">
                                ...
                                <div class="d-flex flex-row justify-content-between align-items-center">
                                    ...
                                    <div class="d-flex flow-row justify-content-end align-items-center">
                                        <i class="fa-solid fa-circle-arrow-up fa-xs" style="color: #43a047;"></i><p class="me-2 mb-0 text-middle fs-7">2</p>
                                        <i class="fa-solid fa-circle-arrow-down fa-xs" style="color: #e53935;"></i><p class="mb-0 text-middle fs-7">2</p></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="mini-item card px-3 d-flex flex-row align-items-center border-0 shadow rounded-3">
                            ...
                            <div class="card-body ps-1 pe-0">
                                ...
                                <div class="d-flex flex-row justify-content-between align-items-center">
                                    ...
                                    <div class="d-flex flow-row justify-content-end align-items-center">
                                        <i class="fa-solid fa-circle-arrow-up fa-xs" style="color: #43a047;"></i><p class="me-2 mb-0 text-middle fs-7">2</p>
                                        <i class="fa-solid fa-circle-arrow-down fa-xs" style="color: #e53935;"></i><p class="me-0 mb-0 text-middle fs-7">2</p></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div id="pluggingMonitoring-right" class="col-lg-95 col-md-12 col-sm-12 col-12 h-100">
                    <div class="row h-100">
                        ...
                        <div id="pluggingMonitoringChart" class="col col-lg-6 col-md-12 col-sm-12 col-12 pb-1 h-100">
                            <div class="row shadow rounded-3 h-100 px-3">
                                <div class="row pt-3 px-1 pe-3">
                                    <h3 class="h3 col-12 text-start fw-bold">Total Damage</h3>
                                </div>
